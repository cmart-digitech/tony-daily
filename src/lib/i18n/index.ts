...
const STRINGS = {
  ...
  askTonyDaily: { en: "Ask The Daily", zh: "問 The Daily" },
  goodMorning: { en: "Good morning", zh: "早晨" },
  dailyBrief: { en: "Your Daily Brief", zh: "今日簡報" },
  marketSnapshot: { en: "Market snapshot", zh: "市場概況" },
  yourWatchlist: { en: "Your watchlist", zh: "自選股焦點" },
  ...
  onboardingWelcome: { en: "Welcome to The Daily", zh: "歡迎使用 The Daily" },
  next: { en: "Next", zh: "下一步" },
  back: { en: "Back", zh: "上一步" },
